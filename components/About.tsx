...
// Register plugins at module level (once, not per-render)
  ...
  useGSAP(() => {
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        pin: true,
        scrub: 0.5, // Reduced from 1 → less lag catching up to scroll position
      }
    });
  ...
  return (
    <div id="about" ref={containerRef} className="relative bg-black">
      <div ref={pinRef} className="relative h-screen w-full overflow-hidden">
        ...
        {/* Background — gpu-layer pre-promotes to compositor for smooth scale animation */}
        <div
          ref={bgRef}
          className="absolute top-0 left-0 w-full h-full z-0 overflow-hidden bg-[#050505] gpu-layer"
        >
          <Image 
        ...
        <div className="relative z-10 h-full w-full grid grid-cols-1 md:grid-cols-2 gap-8 px-[5%] md:px-[10%]">
          ...
          <div className="relative flex items-center justify-center h-full w-full">
            ...
            {/* Step 1 */}
            <div className="text-content gpu-layer absolute w-full max-w-[500px] opacity-100 translate-y-0">
            ...
            {/* Step 2 */}
            <div className="text-content gpu-layer absolute w-full max-w-[500px] opacity-0 translate-y-[20px]">
            ...
            <div className="text-content gpu-layer absolute w-full max-w-[500px] opacity-0 translate-y-[20px]">
              ...
              <p className="text-base leading-[1.6] opacity-70">
                Today, I work at the intersection of cinematic storytelling, user-centric research, and bold editorial design—creatin