        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.6fr_1fr] gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <motion.div 
              ...
              className="gpu-layer group relative bg-white/[0.04] border border-white/[0.09] rounded-[20px] p-6 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:scale-[1.012] hover:border-[#FDE047]/30 hover:shadow-[0_0_40px_rgba(253,224,71,0.12)]"
            >
          ...
          <motion.div 
            ...
            className="gpu-layer group relative bg-white/[0.04] border border-white/[0.09] rounded-[20px] p-6 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:scale-[1.012] hover:border-[#FDE047]/30 hover:shadow-[0_0_40px_rgba(253,224,71,0.12)] flex flex-col"
          >
            <div className="absolute inset-0 rounded-[20px] bg-[radial-gradient(circle_at_30%_30%,rgba(253,224,71,0.07)_0%,transparent_65%)] opacity-0 transition-opacity duration-400 group-hover:opacity-100"></div>
