        ...
        <div className="grid grid-cols-12 gap-3 md:gap-4">
          {playfolioItems.map((item, index) => (
            <motion.article
              ...
              className={`gpu-layer relative group overflow-hidden rounded-2xl bg-[#0a0a0a] border border-white/[0.03] aspect-square md:aspect-auto ${item.className} min-h-[180px] md:min-h-[220px] transition-all duration-500 hover:border-[#FDE047]/20 hover:shadow-[0_15px_50px_-15px_rgba(0,0,0,0.5)]`}
            >
              {/* Image Container */}
              ...
              {/* Noise Overlay — removed mix-blend-overlay (expensive blend mode) */}
