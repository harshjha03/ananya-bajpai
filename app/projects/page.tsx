...
export default function ProjectsPage() {
    ...
    const handleScroll = () => {
      ...
      sections.forEach((section) => {
        ...
        if (rect.top <= 150 && rect.bottom >= 150) {
          setActiveDomain((section as HTMLElement).dataset.domain || 'experiences');
        }
      });
    };
  ...
  return (
    <main className="bg-[#0c0b09] text-[#f0ebe3] font-sans selection:bg-[#c9a87c]/30 min-h-screen relative">
      {/* Static Background Image with Breathing Animation */}
      <div className="fixed inset-0 z-0 overflow-hidden">
        ...
        >
          <Image 
            src="https://lh3.googleusercontent.com/pw/AP1GczMb4-HFP628F46gm9A9iGTfSJX572qJ-cs81kOCYVvRCxWtZFNogQEoxk3RC3nHaCxF6kGL7ijxNBSRUbvK2QvKvvKLobYhSN7rpwccPkyistDxkZow5s3oUfySX7d_fKQS_yktpJOaFcHDrOdCLSCNnA=w1390-h869-s-no-gm?authuser=0"
            alt="Background"
            fill
      ...
      <div className="pt-16 relative z-10">
        {domains.map((domain) => (
          ...
          >
            {/* Domain Overlay - Making it more subtle to let Unicorn background shine through */}
            ...
            <div className="max-w-[1300px] mx-auto px-8 py-24 relative z-10">
              ...
              <header className="relative mb-20 group">
                <div className="absolute -inset-6 bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-3xl -z-10 transition-all duration-500 group-hover:bg-white/[0.05] group-hover:border-white/20" />
...
function ProjectCard({ project, domainAccent }: { project: any, domainAccent: string }) {
  ...
  return (
    ...
    >
      {/* Left: Visuals - Reduced size by using 0.8fr and smaller aspect ratio/max-width */}
      <div className="lg:sticky lg:top-32">
        <div className="aspect-[3/2] w-full max-w-[480px] rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/10 overflow-hidden relative group">
          {project.image ? (
            <Image
              src={project.image}
              alt={project.title}
      ...
      <div className="space-y-10">
        ...
        <div className="flex flex-wrap gap-2">
          {project.tags.map((tag: string) => (
            <span 
              key={tag} 
              className="text-[9px] tracking-[0.15em] uppercase px-4 py-2 rounded-full bg-white/[0.03] backdrop-blur-md border border-white/10 text-white/70"
        ...
        {project.insight && (
          <div 
            className="border-l-2 pl-6 py-5 rounded-r-xl bg-white/[0.02] backdrop-blur-sm"
        ...
        <div className="grid grid-cols-1 gap-12">
          ...
          {project.metrics && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-white/10 border border-white/10 rounded-xl overflow-hidden backdrop-blur-sm">
        ...
        <Link 
          ...
          className="inline-flex items-center gap-3 mt-12 px-8 py-4 rounded-full bg-white/[0.03] backdrop-blur-md border border-white/10 text-[10px] tracking-[0.2em] uppercase text-white/60 hover:text-[#c9a87c] hover:bg-white/[0.06] hover:border-[#c9a87c]/30 transition-all group"
        >
